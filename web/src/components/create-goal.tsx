...
const createGoalForm = z.object({
  ...
  desireWeeklyFrequency: z.coerce.number().min(1,'Selecione a quantidade de vezes na semana').max(7, 'Máximo de 7 vezes por semana'),
})
...
export function CreateGoal() {
  ...
  return (
      ...
      <div className="flex flex-col gap-6">
        ...
        <form onSubmit={handleSubmit(handleCreateGoal)} className="flex-1 flex flex-col justify-between gap-6">
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <Input
                id="title"
                autoFocus 
                className="Praticar exercícios, meditar, etc..."
                {...register('title')}
              />
            ...
            <div className="flex flex-col gap-2">
              ...
              />
              {formState.errors.desireWeeklyFrequency && (
                <p className="text-red-400 text-sm">{formState.errors.desireWeeklyFrequency.message}</p>
              )}
            </div>
          </div>
